...
#define X_DIR_PIN          21 //30 on the broken 'x_dir' board
...
//NJ '7' on Melzi boards, but '1' on RepRap Prusa i2 0x01, as AI7 died :-(
#define TEMP_0_PIN          7   // MUST USE ANALOG INPUT NUMBERING NOT DIGITAL OUTPUT NUMBERING!!!!!!!!! (pin 33 extruder)
#define TEMP_1_PIN         -1
#define TEMP_2_PIN         -1
//NJ '6' on Melzi boards, but '2' on RepRap Prusa i2 0x01, as AI6 died :-(
